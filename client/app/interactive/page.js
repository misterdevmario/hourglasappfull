...
import Transition from "@/home _interactive/transition/Transition";
import HeaderRender from "@/home _interactive/header/HeaderRender";
import Activities from "@/home _interactive/activities/Activities";
import FooterRender from "@/home _interactive/footer/FooterRender";

export default function Page() {
  const { languageMobile, changeLanguageMobile } = useInfo();
    ...
    <main>
      ...
      <div className={display}>
        <IoLanguageSharp
          ...
          onClick={() => {
            languageMobile == "en"
              ? changeLanguageMobile("es")
              : changeLanguageMobile("en");
          }}
        />
        <HeaderRender />
