...
const Staff = () => {
  ...
  useEffect(() => {
    setStaff(info.staffWednesday);
  }, [info.staffWednesday, desc]);

  const handleBioEn = () => {
    const description = info.staffWednesday
            ...
            <div key={item.id}>
              <Form className={styles.form}>
                <div className={styles.inputs}>
                  ...
                  {info.staffWednesday.length > 1 ? (
                    <button
                      type="button"
                      className={styles.delete}
                      onClick={() => deleteStaffWednesday(item.id)}
                    >
                      Eliminar
                    </button>
                  ) : null}
