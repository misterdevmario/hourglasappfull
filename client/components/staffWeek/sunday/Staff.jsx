...
const Staff = () => {
  ...
  useEffect(() => {
    setStaff(info.staffSunday);
  }, [info.staffSunday, desc]);

  const handleBioEn = () => {
    const description = info.staffSunday
            ...
            <div key={item.id}>
              <Form className={styles.form}>
                <div className={styles.inputs}>
                  ...
                  {info.staffSunday.length > 1 ? (
                    <button
                      type="button"
                      className={styles.delete}
                      onClick={() => deleteStaffSunday(item.id)}
                    >
                      Eliminar
                    </button>
                  ) : null}
