...
const Staff = () => {
  ...
  useEffect(() => {
    setStaff(info.staffTuesday);
  }, [info.staffTuesday, desc]);

  const handleBioEn = () => {
    const description = info.staffTuesday
            ...
            <div key={item.id}>
              <Form className={styles.form}>
                <div className={styles.inputs}>
                  ...
                  {info.staffTuesday.length > 1 ? (
                    <button
                      type="button"
                      className={styles.delete}
                      onClick={() => deleteStaffTuesday(item.id)}
                    >
                      Eliminar
                    </button>
                  ) : null}
