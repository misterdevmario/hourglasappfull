...
const Staff = () => {
  ...
  useEffect(() => {
    setStaff(info.staffSaturday);
  }, [info.staffSaturday, desc]);

  const handleBioEn = () => {
    const description = info.staffSaturday
            ...
            <div key={item.id}>
              <Form className={styles.form}>
                <div className={styles.inputs}>
                  ...
                  {info.staffSaturday.length > 1 ? (
                    <button
                      type="button"
                      className={styles.delete}
                      onClick={() => deleteStaffSaturday(item.id)}
                    >
                      Eliminar
                    </button>
                  ) : null}
