...
const Flyers = ({ flyerInfo }) => {
  ...
  return (
    <div className={styles.container}>
      {flyerInfo?.map((item, i) => (
        <Formik
          ...
          onSubmit={async (data, actions) => {
            if (selectedDay == "lunes") await updateFlyerMonday(data, item.id);
                ...
                <div className={styles.inputs}>
                  ...
                  {flyerInfo?.length > 1 ? (
                    <button
                      ...
                      onClick={() => {
                        if (selectedDay == "lunes") deleteFlyerMonday(item.id);
                        if (selectedDay == "martes")
      ...
      <ModalDesc isOpen={isOpenModalFlyerEn} En closeModal={closeModalFlyerEn}>
