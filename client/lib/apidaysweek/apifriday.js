...
export async function getActivitiesFriday() {
  ...
  export async function deleteActivitiesFriday(id) {
    const res = await fetch(
      `${process.env.NEXT_PUBLIC_STRAPI_URL}/activityfridays/${id}`,
      {
        method: "DELETE",
      }
    );
  ...
  //Method GET
  export async function getStaffFriday() {
    const res = await fetch(
  ...
  //Method PUT
  export async function putStaffFriday(data, id) {
    const res = await fetch(
  ...
  //Method DELETE
  export async function deleteStaffFriday(id) {
    const res = await fetch(
      `${process.env.NEXT_PUBLIC_STRAPI_URL2}/stafffridays/${id}`,
      {
        method: "DELETE",
