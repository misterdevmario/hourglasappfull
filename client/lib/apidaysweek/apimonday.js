...
export async function getActivitiesMonday() {
  const res = await fetch(
    `${process.env.NEXT_PUBLIC_STRAPI_URL2}/activitymondays?pagination[page]=1&pagination[pageSize]=50`
  );
...
export async function deleteActivitiesMonday(id) {
  const res = await fetch(
    `${process.env.NEXT_PUBLIC_STRAPI_URL}/activitymondays/${id}`,
    {
      method: "DELETE",
    }
  );
...
//Method GET
export async function getStaffMonday() {
  const res = await fetch(
...
//Method PUT
export async function putStaffMonday(data, id) {
  const res = await fetch(
...
//Method DELETE
export async function deleteStaffMonday(id) {
  const res = await fetch(
    `${process.env.NEXT_PUBLIC_STRAPI_URL2}/staffmondays/${id}`,
    {
      method: "DELETE",
